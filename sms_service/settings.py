...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-u)jew*#wzyzu8q&8fbdh7ghdqgk4s##$6e_n*xo98i$y2l$d%w')
...
SMS_API_URL = os.getenv('SMS_API_URL', 'https://api.twilio.com/Messages.json')
SMS_API_KEY = os.getenv('SMS_API_KEY', '')
SMS_SENDER = os.getenv('SMS_SENDER', 'SMS Service')
SMS_MAX_RETRIES = int(os.getenv('SMS_MAX_RETRIES', '3'))
SMS_RETRY_DELAY = int(os.getenv('SMS_RETRY_DELAY', '1'))
